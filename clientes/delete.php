...
<div id="container">
        <h1>&bull; <?=$_GET['CodCliente']?> &bull;</h1>
        <br>
        <div class="underline">
        </div>
        <form action="delete.php" method="post" id="contact_form">
          <div class="telephone">
            <label for="name">¿Seguro que quiere eliminar el cliente con código <?=$_GET['CodCliente']?>?</label>
          ...
          <div class="submit">
            ...
            <input type="button" onclick="location.href='../clientes/clientes.php'" value="Enviar" id="form_button" />
            <input type="button" onclick="location.href='../clientes/form.php?CodEmpleado=<?=$clientes['CodCliente']?>'" value="Cancelar" id="form_button" />
