...
$stm = $conn->query("select * from recambios order by (IdRecambio*1)");
$stm->execute();
$recambio = $stm->fetchAll();
    ...
    <div class="root">
        ...
        <section class="main-content">
            <section class="content">
                ...
                <div class="Facturas">
                    <h1 class="page-title">RECAMBIOS</h1>
                    <button id="new" onclick="location.href='../recambios/form.php'">Nuevo recambio</button>
                    <table>
                        <tr>
                            <th>Id Recambio</th><th>Descripción</th><th>UnidadBase</th><th>Stock</th><th>PrecioReferencia</th>
                        </tr>

                        <?php foreach($recambio as $e): ?>
                            <tr>
                                <td>
                                    <a href="show.php?IdRecambio=<?=$e['IdRecambio']?>">
                                        <?=$e['IdRecambio']?>
                                    </a>
                                </td>
                                <td><?=$e['Descripcion']?></td>
